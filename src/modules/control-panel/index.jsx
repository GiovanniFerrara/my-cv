...
const ControlPanel = (props) => {
  return (
    <ControlPanelBase>
      ...
      <Zoom>
        <Button
          onClick={() => props.handleZoomChange(ZOOM_TYPE.IN)}
          width="40px"
        >
          +
        </Button>
        <Button
          onClick={() => props.handleZoomChange(ZOOM_TYPE.OUT)}
          width="40px"
        >
          -
        </Button>
...
ControlPanel.propTypes = {
  ...
  getPrintableComponentRef: PropTypes.func.isRequired,
  onBeforeGetContent: PropTypes.func.isRequired,
